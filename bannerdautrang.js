...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://goo.gl/rKJWvA' target='_blank'><form action='https://docs.google.com/forms/d/e/1FAIpQLSf-S-MAi1nAZBv9tP8pu9EDsOlqqbBr7RR6dbT0Wr5QMWeLOA/formResponse' id='ss-form' method='POST' onsubmit='submitted=true;' target='hidden_iframe'>
